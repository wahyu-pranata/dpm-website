            ...
            <div class="col-12">
                <div class="card shadow mb-4">
                    ...
                    <div
                        ...
                        <button class="btn btn-primary" data-toggle="modal" data-target="#documentForm" id="BtnCreate" data-service="create">Add Document</button>
                    </div>
                    <!-- Card Body -->
                    <div class="card-body">
                        @if($documents)
                                    ...
                                    <div class="list-group-item list-group-item-action flex-column align-items-start">
                                        <div class="d-flex w-100 justify-content-between">
                                            ...
                                            <div class="d-flex">
                                                ...
                                                @endif
                                                @if($document->file)
                                                    <a href="{{$document->file}}" class="btn btn-primary mr-3" target="_blank">Download Document</a>
                                                @endif
                                                <button class="btn btn-primary button-edit mr-3" data-id="{{ $document->id }}" data-service="edit" data-toggle="modal" data-target="#documentForm">Edit</button>
